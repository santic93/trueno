document.addEventListener('DOMContentLoaded', function () {
  var text =
    'Mateo Palacios Corazzina, Trueno, rapero, cantante y freestyler argentino. Comenzó su carrera en las batallas de freestyle, cuando intentó participar en los torneos porteños A Cara de Perro Zoo Juniors y Red Bull Regional.Se consagró campeón de la competencia A Cara de Perro Zoo Juniors. Participó en varios torneos de freestyle, tanto nacionales como internacionales.Apoyado por el sello discográfico Neuen, comenzó con su carrera musical al lanzar su sencillo debut «K.I.N.G.», y ese mismo año se consagró campeón de la competencia “Cruce de Campeones”.Tras su éxito, anunció su retiro de las batallas de freestyle y se centró principalmente en su carrera musical.En 2020 lanzaría su álbum debut de estudio, Atrevido, bajo el sello discográfico Neuen y distribuido por Sony Music Latin';
  var delay = 25; // Retraso entre cada carácter (en milisegundos)
